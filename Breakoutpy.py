...
pygame.display.set_caption('Breakout if you can!!')
font = pygame.font.SysFont('Consolas', 30)

bg = (255,240,245)
block_lblue =  (100,149,237) 
block_dblue = (0,0,255) 
block_black = (0,0,0) 

paddle_col = (48,48,48)
paddle_outline = (3,3,3)
        ...
        for row in self.blocks:
            for block in row:
                ...
                if block[1] == 3:
                    ...
                    block_col = block_dblue
                elif block[1] == 1:
                    block_col = block_lblue
...
while run:
    ...
    if not live_ball:
        if game_over == 0:
            draw_text('CLICK TO START', font, text_col, 180, screen_height // 2 + 100)
        elif game_over == 1:
            draw_text('GAME COMPLETE!', font, text_col, 220, screen_height // 2 + 50)
            draw_text('CLICK TO START', font, text_col, 180, screen_height // 2 + 100)
        elif game_over == -1:
